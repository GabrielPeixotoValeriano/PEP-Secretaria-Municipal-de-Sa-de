    ...
    document.getElementById('patient-form').addEventListener('submit', function(event) {
        ...
        if (treatmentMessage !== "") {
            ...
            if (resultDTG5mg) {
                ...
                prescriptionHtml += `<li><strong>1 - ${resultDTG50mg.medication.toUpperCase()}</strong>, tomar <strong>${resultDTG50mg.comprimidos}</strong> comprimidos de 50mg diluídos em água, uma vez ao dia, durante 28 dias.</li>`;
            }
