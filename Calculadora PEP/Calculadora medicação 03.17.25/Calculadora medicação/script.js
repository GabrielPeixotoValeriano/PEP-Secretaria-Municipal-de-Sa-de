document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('patient-form').addEventListener('submit', function(event) {
        ...
        if (!weight || !healthUnit || !patientName || !patientAddress || !patientGender) {
        ...
        // Exibição dos dados do paciente, incluindo o nome social se fornecido
        prescriptionHtml += 
        ...
        if (treatmentMessage !== "") {
            ...
            if (resultDTG5mg) {
                prescriptionHtml += `<li><strong>1 - ${resultDTG5mg.medication.toUpperCase()}</strong>, tomar <strong>${resultDTG5mg.comprimidos}</strong> comprimidos de 5mg diluídos em água, uma vez ao dia, durante 28 dias.</li>`;
