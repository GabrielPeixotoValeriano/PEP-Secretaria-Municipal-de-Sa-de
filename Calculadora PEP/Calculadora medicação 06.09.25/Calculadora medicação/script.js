document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('patient-form').addEventListener('submit', function(event) {
        ...
        const expValue = document.getElementById('exposure-datetime').value;  // captura nova data
        ...
        const exposure = new Date(expValue);  // nova data convertida

        const age = calculateAge(dob);
        const hoursExp = hoursSinceExposure(exposure);  // calcula horas
        ...
        // Monta cabeçalho e infos, incluindo horas desde exposição
        ...
        // Se > 72h, exibe alerta e não faz cálculos
        if (hoursExp > 72) {
            prescriptionHtml += `
            ...
            // Segue lógica original de PEP RN / PEP Adulto ou infantil
